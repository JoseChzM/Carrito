...
//BASE DE DATOS
	var productos = ["HikVision (4 Camaras)", "HikVision (8 Camaras)", "Epcom (4 Camaras)", "Epcom (8 Camaras)", "Saxxon Pro (4 camaras)", "ANRAN (6 camaras)", "Kit 2 Cables Cctv", "Kit 4 Gabinetes ", "Kit De Herramientas "];
	var imgGrandes = ["img/productos/mod11.jpg", "img/productos/mod12.jpg", "img/productos/mod13.jpg", "img/productos/mod14.jpg", "img/productos/mod15.jpg", "img/productos/mod16.jpg", "img/productos/mod17.jpg", "img/productos/mod18.jpg", "img/productos/mod19.jpg"];
	var imgPeque = ["img/productos/mod1.jpg", "img/productos/mod2.jpg", "img/productos/mod3.jpg", "img/productos/mod4.jpg", "img/productos/mod5.jpg", "img/productos/mod6.jpg", "img/productos/mod7.jpg", "img/productos/mod8.jpg", "img/productos/mod9.jpg"];
	var precios = [3099, 6599, 4499, 7149, 2000, 7709, 580, 200, 1249];
	var stock = [5, 2, 8, 3, 10, 4, 3, 1, 2];
	var precioTransporte = [200, 100, 50, "gratis"];
	var IVA = 0.16;
	var uniUser;
...
var confirmmessage = "Deseas Imprimir tu comprobante con instrucciones necesarias?";
  var go = "pdf.html";
  var message = "Gracias por utilizar nuestro servicio de venta Camwiki";
